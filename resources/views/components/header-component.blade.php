...
{{-- <x-new-sidebar-component></x-new.new-sidebar-component> --}}
<header x-data="{ isFixed: true }" x-init="window.addEventListener('scroll', () => { isFixed = window.scrollY > 50 })" :class="{ 'fixed top-0 right-0 w-full z-[999999999999999999]': isFixed, 'static': !isFixed }">
{{-- <header> --}}
    <div class="shadow bg-white relative z-20">
        <div class="container cent_bet xl:gap-20 gap-8 my-22">
            <div>
                <p class="font-medium text-[24px]">Be3o</p>
            </div>
            <div class="flex gap-4">
                <div class="flex h-10 rounded my-5 shadow">
                    <input type="search"
                        class="border border-borderColor bg-white rounded-l-sm px-6 py-2.5 text-stone-500 text-sm font-light xl:min-w-[435px] min-w-[250px]"
                        placeholder="Search for categories & items" aria-label="Search"
                        aria-describedby="button-addon1" />
                    <button class="relative border border-borderColor z-10 cent bg-hover text-xs w-10 rounded-r-sm"
                        type="button" id="button-addon1" data-te-ripple-init data-te-ripple-color="light">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.125 17L11.125 11" stroke="#09537C" stroke-width="1.7" stroke-linecap="round">
                            </path>
                            <path
                ...
                <div
                    class="flex lg:justify-between shadow bg-white rounded-sm relative w-full h-10 border border-borderColor pr-1 my-5 px-2 max-w-36">
                    <div class="cent">
                    ...
                    <select name="location" id="location"
                        class="text-stone-500 text-sm font-light border-none focus:!ring-0">
                ...
                <div class="hidden lg:flex justify-center items-center">
                    <button type="button" class="cent py-2 text-sm font-medium cursor-pointer"
                        ...
                        <img src="{{ asset('assets/images/usa.svg') }}" class="mr-1">
                        <span class="hidden lg:block text-lg">En</span>
                    </button>
                    <!-- Dropdown menu -->
            ...
            <div class="flex gap-6">
                <div class="hidden lg:flex">
                    <div class="cent gap-4">
                        <div class="cent w-10 h-10 bg-hover rounded-full">
                ...
                <div>
                    <button class="button-prim gap-4">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M7.5 12H12M12 12H16.5M12 12V7.5M12 12V16.5M21 3.6V20.4C21 20.5591 20.9368 20.7117 20.8243 20.8243C20.7117 20.9368 20.5591 21 20.4 21H3.6C3.44087 21 3.28826 20.9368 3.17574 20.8243C3.06321 20.7117 3 20.5591 3 20.4V3.6C3 3.44087 3.06321 3.28826 3.17574 3.17574C3.28826 3.06321 3.44087 3 3.6 3H20.4C20.5591 3 20.7117 3.06321 20.8243 3.17574C20.9368 3.28826 21 3.44087 21 3.6Z"
    ...
    <div class="cent w-full h-[51px] bg-white shadow relative z-10">
        <ul class="container cent gap-12 whitespace-nowrap">
            <li>
                <a href="#"
                    class="hidden md:block xl:text-lg text-base font-semibold text-black md:text-primary">Home</a>
            </li>
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">Vehicles</a>
            </li>
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">Electronics</a>
            </li>
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">Clothes</a>
            </li>
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">Clothes</a>
            </li>
            ...
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">Furnitures</a>
            </li>
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">Furnitures</a>
            </li>
            ...
            <li class="pt-2.5 md:pt-0">
                <a href="#" class="xl:text-lg md:text-base text-xs font-normal text-black">All
                    Categories</a>
            </li>
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">Contact
                    Us</a>
            </li>
            <li>
                <a href="#" class="hidden md:block xl:text-lg text-base font-normal text-black">About
                    Us</a>
            </li>
        </ul>
    </div>
